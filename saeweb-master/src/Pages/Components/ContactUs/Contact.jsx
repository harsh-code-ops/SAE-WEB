...
const Contact = () => {
    ...
    const Send= async (e)=> {
        ...
        if (name && email && phone && message) {
            setmsgprocess(true)
            axios.post("https://long-ruby-snapper-hose.cyclic.app/message",item)
            .then((res)=> {
    ...
    <div className='maincontactdiv' >
        ...
        <div className='upperdivcontact'>
            <div className="contactusheading">
                ...
                <div className="condesc">Whether you have a question or like to get part of our team - this form will get you in contact with us!</div>
            </div>
            
            {success && <div className='errconbox'> <Success Hd="Thank you!" desc='Your message has been successfully sent. We will contact you very soon!'/> </div>}
            
        </div>
        <div className='maincontactinputdiv' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='200'>
            <div className='inputleftdiv'>
                <div className='msgtextheading'>SEND US YOUR QUERY</div>
                  ...
                  <div className='inputinsideleft'>
                    ...
                    <div className='labeldiv'>
                            <div className='labels'>{msgerr?(<span className='errred'>This field is required</span>):"Message"}</div>
                            <textarea defaultValue={null} style={{width:"100%",height:"100px"}}
                     ...
                     <div className='btndiv'><button className='btn1' type='submit'onClick={Send}>{msgprocess?(<BiLoaderCircle/>):"Send"} </button></div>
                    </div>
            ...
            <div className='textadressdiv'>
                <div className='contactinfo'>CONTACT INFORMATION</div>
                   <div className="contacttexts">
                       <div className="locationbox">
                           <div className="symbols"><HiLocationMarker/></div>
                           <div className="locationtexts">Department of Mechanical Engineering,Zakir Husain College of Engineering and Technology,Aligarh Muslim University,Aligarh,Uttar Pradesh-202002</div>
                       </div>
                       <div className="emailbox">
                           <div className="symbols"><MdEmail/></div>
                           <div className="emailtext"><a href = "mailto: sae@zhect.ac.in">sae@zhect.ac.in</a></div>
                       </div>
                       <div className="phonebox">
                           <div className="symbols"><AiFillPhone/></div>
                           <div className="phonenumber"><a href="tel: 87911 94090"> 87911 94090 </a><a href="tel: 97200 06363">, 97200 06363</a></div>
                       </div>
                ...
                <div className="contactlinks">
                    ...
                    <a href="" className="youtube">
                        <FontAwesomeIcon icon={faYoutube} style={{color:"white"}} size="2x" />
                    </a>
            ...
            <div className='mapcon' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='300' >
